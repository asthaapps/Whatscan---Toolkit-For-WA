...
import com.whatscan.toolkit.forwa.Intro.ActivitySplash;
...
public class AppOpenManager implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    public void fetchAd() {
        ...
        AppOpenAd.load(myApplication, Preference.getApp_Open(), adRequest, AppOpenAd.APP_OPEN_AD_ORIENTATION_PORTRAIT, loadCallback);
    }
