...
public class ActivityFackUserChat extends AppCompatActivity implements OnClickListener, OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Constant.adjustFontScale(getResources().getConfiguration(), ActivityFackUserChat.this);
        setContentView(R.layout.activity_fack_user_chat);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.userdetails:
                Intent editchatuser = new Intent(this, ActivityEditChatUserProfile.class);
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int item) {
                if (items[item].equals("Me")) {
                    ActivityFackUserChat.this.sender = "yes";
                    ActivityFackUserChat.this.SelectImageFromgallery();
                } else if (items[item].equals("My Friend")) {
                    ActivityFackUserChat.this.sender = "no";
                    ActivityFackUserChat.this.SelectImageFromgallery();
                }
            }
        });
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        Intent editmessageintent = new Intent(this, ActivityEditMessage.class);
    ...
    private class btnMessageListner implements TextWatcher {
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            if (count > 0) {
                ActivityFackUserChat.this.ViewLayout();
                return;
            }
            ActivityFackUserChat.this.messageLayout.setVisibility(View.INVISIBLE);
            ActivityFackUserChat.this.recordlayout.setVisibility(View.VISIBLE);
            ActivityFackUserChat.this.camera.setVisibility(View.VISIBLE);
            ActivityFackUserChat.this.attach.setVisibility(View.VISIBLE);
        }
    ...
    private class btnEmojiIconListner implements KeyboardListener {
        public void onKeyboardOpen() {
            Log.e(ActivityFackUserChat.TAG, "Keyboard opened!");
        }

        public void onKeyboardClose() {
            Log.e(ActivityFackUserChat.TAG, "Keyboard closed");
        }
    }

    private class btnCallListner implements OnClickListener {
        public void onClick(View view) {
            ActivityFackUserChat.callImages = ActivityFackUserChat.this.getImagefromdatabase(ActivityFackUserChat.this.profile);
            Intent intent = new Intent(ActivityFackUserChat.this, ActivityFackCalls.class);
            intent.putExtra("NAME", ActivityFackUserChat.this.username);
            intent.putExtra("ID", 2);
            ActivityFackUserChat.this.startActivity(intent);
        }
    }
