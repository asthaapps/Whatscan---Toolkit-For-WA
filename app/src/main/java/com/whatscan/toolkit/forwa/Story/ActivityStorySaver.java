...
public class ActivityStorySaver extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    public RelativeLayout rl_story;
    ArrayList<StatusModel> statusModels;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Constant.adjustFontScale(getResources().getConfiguration(), ActivityStorySaver.this);
        setContentView(R.layout.activity_story_saver);

        Utils.CheckConnection(ActivityStorySaver.this, findViewById(R.id.rl_story));
        FindView();
    }

    private void FindView() {
        LinearLayout ll_banner = findViewById(R.id.ll_banner);
        Advertisement.showBannerAds(ActivityStorySaver.this, ll_banner);
        ...
        tv_toolbar.setText(Html.fromHtml("<small>" + getString(R.string.story_saver) + "</small>"));

      statusModels = getIntent().getParcelableArrayListExtra("arrayListStatus");

        if (Preference.getBooleanTheme(false)) {
            setStatusBarTheme();
            rl_story.setBackgroundColor(ContextCompat.getColor(this, R.color.darkBlack));
            ...
            setStatusBar();
            rl_story.setBackgroundColor(ContextCompat.getColor(this, R.color.colorWhite));
        ...
        la_info.setOnClickListener(v -> com.whatscan.toolkit.forwa.Util.Constant.BottomSheetDialogView(ActivityStorySaver.this, getString(R.string.story_title), getString(R.string.story_text)));
    }

    private void setupViewPager(ViewPager viewPager) {
        Pager pager = new Pager(getSupportFragmentManager());
        pager.addFragment(new FragmentImage(statusModels), getString(R.string.images));
        pager.addFragment(new FragmentVideo(statusModels), getString(R.string.videos));
        pager.addFragment(new FragmentDownload(), getString(R.string.download));
    ...
    public void onNetworkConnectionChanged(boolean isConnected) {
        Utils.showSnack(ActivityStorySaver.this, findViewById(R.id.rl_story), isConnected);
    }
